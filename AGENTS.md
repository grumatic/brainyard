...
The canonical instruction file for this repository. `CLAUDE.md` imports it
verbatim, so there is exactly one copy of every rule and no chance of the two
drifting apart. Codex and Cursor read this file directly.
